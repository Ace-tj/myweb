      ...
      <section className="py-16">
        <div className="grid gap-10 lg:grid-cols-5">
          ...
          <aside className="space-y-6 lg:col-span-2">
            <div className="rounded-sm border border-border bg-bg p-7">
              <div className="spec-line">{t("directTitle")}</div>
            ...
            <div className="rounded-sm border border-border bg-surface/40 p-7">
              <div className="spec-line">{t("hurryTitle")}</div>
